  ...
  return (
    <div className="p-6 max-w-xl mx-auto w-full min-h-screen pb-20">
      <div className="flex items-center justify-between mb-4">
        <button 
          onClick={() => navigate(-1)} 
          className="bg-slate-800 hover:bg-slate-700 text-cyan-300 px-3.5 py-2 rounded-xl text-xs font-bold border border-slate-700 shadow-md transition-all flex items-center gap-1.5 cursor-pointer"
        >
          <span>←</span> Back
        </button>
        <span className="text-xs text-slate-400 font-mono font-semibold">SafeRoute AI Navigation</span>
      </div>
